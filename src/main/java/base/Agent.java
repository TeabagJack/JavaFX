...
public class Agent {
    ...
    public void setGuiMoveList(ArrayList<int[]> guiMoveList) {
        this.guiMoveList = guiMoveList;
    }

    ArrayList<int[]> guiMoveList;

    public Agent(int[] position, int angle) {
        ...
        this.guiMoveList = new ArrayList<>();
