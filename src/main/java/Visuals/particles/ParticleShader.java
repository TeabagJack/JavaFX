...
public class ParticleShader extends ShaderProgram3D {
	...
	private static final String VERTEX_FILE = "src/main/java/Visuals/particles/particleVShader.txt";
	private static final String FRAGMENT_FILE = "src/main/java/Visuals/particles/particleFShader.txt";
